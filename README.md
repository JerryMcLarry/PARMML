...
| Biomes O' Plenty | 2.1.0 | 21.1.0.13 | World-gen mod. **Relies on GlitchCore and TerraBlender.** | [Modrinth Page](https://modrinth.com/mod/biomes-o-plenty) |
| Caelus | 7.0.1 | - | API library. ***Used for ElytraSlot.*** | [Modrinth Page](https://modrinth.com/mod/caelus) |
| CarryOn | 2.2.2.11 | 2.2.3 | Allows for players to move around "tile entities" *(chests, furnaces, droppers and the like)* using empty hands. Can also carry around small mobs and stack them ontop of each other. | [Modrinth Page](https://modrinth.com/mod/carry-on) |
| CarryOn Extend | 1.4-hotfix | 1.5 | Extension of CarryOn, allowing for players to *throw* the object they're carrying. | [Modrinth Page](https://modrinth.com/mod/carry-on-extend) |
...
| Dummmmmy (MmmMmmMmmMmm) | 2.0.6 | 2.0.11 | Target dummy mod. Armours can be equipped onto the dummy. | [Modrinth Page](https://modrinth.com/mod/mmmmmmmmmmmm)
...
| MrCrayfish's Framework API | 0.9.4 | 0.13.6 | API library for MrCrayfish's mods. **Used for Refurbished Furniture.** | [Download Page](https://mrcrayfish.com/mods/framework) |
| GeckoLib | 4.7.3 | 4.8.2 | API library for animations. ***Used for Point Blank.*** | [Modrinth Page](https://modrinth.com/mod/geckolib) |
| GlitchCore | 2.1.0.0 | - | API library. ***Used for Biomes O' Plenty.*** | [Modrinth Page](https://modrinth.com/mod/glitchcore) |
| Gravestone | 1.0.21 | 1.0.35 | Mod that creates a breakable gravestone containing inventory when you died. | [Modrinth Page](https://modrinth.com/mod/gravestone-mod) |
| Guard Villagers | 2.3.2 | 2.4.5 | Mod that creates a new villager type that allows for easier defense of the various villagers. | [Modrinth Page](https://modrinth.com/mod/guard-villagers) |
| Haven Cobble Generators | 1.0.6 | 1.0.8(!) | Mod that adds blocks that creates cobblestone and/or similar stones for free. | [CurseForge Page](https://www.curseforge.com/minecraft/mc-mods/haven-cobble-generators) |
| Immersive Aircraft | 1.1.5 | 1.4.0 | Mod that allows for the creation of various aircraft. | [Modrinth Page](https://modrinth.com/mod/immersive-aircraft/changelog) |
...
| Jade | 15.9.4 | 15.10.3 | Mod that displays information about whatever the player is looking at. | [Modrinth Page](https://modrinth.com/mod/jade) |
| Just Enough Items | 19.21.0.247 | 19.25.1.332 | Mod that lists all possible items within a server. Also displays crafting recipes that pertain to that particular item. | [Modrinth Page](https://modrinth.com/mod/jei) |
| Kotlin for Forge | 5.7.0 | 5.10.0 | API library. ***Used for Cobblemon.*** | [Modrinth Page](https://modrinth.com/mod/kotlin-for-forge) |
...
| Moonlight | 2.17.12 | 2.28.2 | API library. Noted to be used for "custom map markers, villager activities, and dynamic data pack usage" among many other uses. | [Modrinth Page](https://modrinth.com/mod/moonlight) |
